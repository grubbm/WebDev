...
var expression = "set " + req.body.newfield + " =:n";
var params = {
    TableName:table,
    Key:{
        "type": type,
...
var params = {
	...
	UpdateExpression: "set vineyard = :v",
	ExpressionAttributeValues:{
	":v":vineyard   
    },
	ReturnValues:"UPDATED_NEW"
...
docClient.update(params, function(err, data) {
    if (err) {
        sendback = "Unable to add item. Error JSON:" + JSON.stringify(err, null, 2);
    } else {
        sendback = "Added item:" + JSON.stringify(data, null, 2);
    }
}); 
}
